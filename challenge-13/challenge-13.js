(function() {
    ...
    */
    ...
    var hasMoreThan7 = brasil.every(function(item){
        return item.length > 7;
    });
    console.log( hasMoreThan7 ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!' );
