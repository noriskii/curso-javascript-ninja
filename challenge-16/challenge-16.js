(function() {
    ...
    */
    var fullName = 'lucas-augusto-silva';
    ...
    */
    var friends = ['Rivolta', 'Julia', 'Pavanini', 'Dorigão', 'Henry'];
    console.log( '\nMeus amigos:' );
    console.log(friends.reduce(function(prev, curr, idx, arr) {
        if(idx === (arr.length - 1)) {
            prev += ' e ' + curr + ' são meus amigos.';
        } else {
            prev += ', ' + curr;
        }
        return prev;
