(function (){
  ...
  */
  ...
  var lucas = new Person('Lucas Augusto', 'Silva', 22);
  var jessica = new Person('Jéssica Layane', 'Costa Melo', 22);
  var rivolta = new Person('Fernando Felix', 'Rivolta', 20);
  ...
  */
  ...
  console.log(rivolta.getFullName());
  ...
  */
  ...
  console.log(rivolta.getFullName() + ' tem ' + rivolta.getAge() + ' anos.');
